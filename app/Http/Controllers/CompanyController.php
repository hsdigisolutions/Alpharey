...
{
    public function index(DocumentStatus $status, DocumentPanelPayload $panel): Response
    {
        ...
        return Inertia::render('Companies/Index', [
            'companies' => Company::query()
                ...
                ->map(function (Company $company) use ($status, $panel, $employeeCounts): array {
                    $current = $company->documents->where('is_current', true);
                    ...
                    return [
                        ...
                        'documents' => $panel->rows($company->documents, 'company', $company->ccc),
                    ];
                }),
