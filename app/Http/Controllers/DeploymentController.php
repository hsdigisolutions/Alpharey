...
class DeploymentController extends Controller
{
     ...
     */
    public function complete(Request $request, EmployeeDeployment $deployment, DeploymentChargeService $charges): RedirectResponse
    {
    ...
    public function cancel(Request $request, EmployeeDeployment $deployment): RedirectResponse
    {
        Gate::authorize('deployments.edit');
        $this->assertVisible($deployment);
