...
class ReportExport implements FromArray, WithHeadings, WithTitle
{
    ...
    public function headings(): array
    {
        return match ($this->module) {
            ...
            'profitability' => ['Proyecto / Project', 'Cliente / Client', 'Horas / Hours', 'Ingresos / Revenue', 'Coste MO / Labour', 'Gastos / Expenses', 'Beneficio / Profit', 'Margen % / Margin %', 'Gasto operativo / Operational overhead'],
    ...
    public function array(): array
    {
        return match ($this->module) {
            ...
            'profitability' => array_map(fn (array $r): array => [
                $r['project'], $r['client'], $r['hours'], $r['revenue'], $r['coste_mo'], $r['gastos'], $r['profit'], $r['margin'] ?? '—', $r['operational_overhead'] ?? 0,
            ], $this->report['rows']),
